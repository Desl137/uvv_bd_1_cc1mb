...
GRANT ALL PRIVILEGES ON *.* TO 'lucas'@localhost IDENTIFIED BY '123';
CREATE DATABASE uvv;
USE uvv;
...
VALUES
('12345678966', 'João', 'B', 'Silva', '1965-01-09', 'Rua das Flores, 751, SãoPaulo, SP', 'M', 30000.00, '33344555587', 5),
('33344555587', 'Fernando', 'T', 'Wong', '1955-12-08', 'Rua da Lapa, 34, SãoPaulo, SP', 'M', 40000.00, '88866555576', 5),
('99988777767', 'Alice', 'J', 'Zelaya', '1968-01-19', 'Rua Souza Lima, 35, Curitiba, PR', 'F', 25000.00, '98765432168', 4),
('98765432168', 'Jennifer', 'S', 'Souza', '1941-06-20', 'Av.Arthur, 54, SantoAndré, SP', 'F', 43000.00, '88866555587', 4),
